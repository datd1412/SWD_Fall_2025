    ...
    >
      <Toolbar sx={{ minHeight: 80, px: 4, display: 'flex', justifyContent: 'space-between' }}>
                ...
                <React.Fragment key={c.to}>
                  {i < crumbs.length - 1 ? (
                    ...
                    <Link
                      ...
                      sx={{ mr: 0.5, color: i === 0 ? '#2fb56c' : 'text.secondary', fontWeight: i === 0 ? 700 : 500 }}
                    >
                      {c.label}
                    </Link>
                  ) : (
                    // current page (last crumb) - plain text with aria-current
                    <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 600 }} aria-current="page">
                      {c.label}
                    </Typography>
                  )}
                  {i < crumbs.length - 1 && (
        ...
        <Stack direction="row" alignItems="center" spacing={2}>
          ...
          >
            <Avatar sx={{ bgcolor: '#b2e5c2', color: '#222', fontWeight: 700, width: 40, height: 40 }}>
              NA
            </Avatar>
          </IconButton>
        </Stack>
